                ...
                <div class="col-lg-3 mb-2 mb-md-0">
                    <div class="widget">
                        ...
                        <ul class="contact-info">
                            ...
                            <li>
                                <span class="contact-info-label">Email:</span> <a href="mailto:mail@example.com">chamee92@gmail.com</a>
                            </li>
{{--                            <li>--}}
...
{{--                            </li>--}}
    ...
    <div class="footer-bottom">
        <div class="container d-flex justify-content-between align-items-center flex-wrap">
            <p class="footer-copyright py-3 pr-sm-4 pr-0 mb-0">Chameera. &copy; 2021. All Rights Reserved</p>
